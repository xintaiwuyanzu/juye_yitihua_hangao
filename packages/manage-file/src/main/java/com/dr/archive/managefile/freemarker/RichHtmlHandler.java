...
public class RichHtmlHandler {
    ...
    public static boolean getImgBase64ToImgFile(String imgBase64, String imgPath) {
        ...
        try {
            ...
            imgBase64 = imgBase64.substring(imgBase64.indexOf(",", 1) + 1, imgBase64.length());
     ...
     */
    public void handledHtml(boolean isWebApplication, String wordImgPath)
            throws IOException {
        ...
        for (Element item : imags) {
            ...
            //将图片src里面的图片放到指定地点
            getImgBase64ToImgFile(src, wordImgPath);
            String srcRealPath = wordImgPath;
