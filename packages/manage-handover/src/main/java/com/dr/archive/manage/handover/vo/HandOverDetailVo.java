package com.dr.archive.manage.handover.vo;
...
public class HandOverDetailVo {
    ...
    private List<HandOverDetailVo> voList;
    ...
    public List<HandOverDetailVo> getVoList() {
        return voList;
    }

    public void setVoList(List<HandOverDetailVo> voList) {
        this.voList = voList;
    }
}
