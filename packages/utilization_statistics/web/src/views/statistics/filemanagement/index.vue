                    ...
                    <el-card class="box-card" style="height: 40vh">
                        ...
                        <div class="table-container" style="height: 100%">
                            <el-table ref="applyTable"
                                ...
                                <el-table-column label="移交数量" prop="mlQuantity" show-overflow-tooltip align="center"></el-table-column>
                    ...
                    <el-card class="box-card" style="height: 40vh">
                        ...
                        <div class="table-container" style="height: 100%">
                            <el-table ref="applyTable"
                                      ...
                                      v-loading="loading">
                                <column-index :page="page"/>
                                <el-table-column label="接收数量" prop="count" show-overflow-tooltip align="center"></el-table-column>
                                <el-table-column label="年度" prop="year" align="center"></el-table-column>
                            </el-table>
                        </div>
                    </el-card>
    ...
    export default {
        ...
        methods: {
            ...
            async loadData() {
                ...
                if(data.data.yj != undefined){
                    this.yj = data.data.yj
                }
