 ...
 * @author dr
 */
@Table(name = Constants.TABLE_PREFIX + "FOND", module = Constants.MODULE_NAME, comment = "全宗类")
public class Fond extends BaseDescriptionEntity<String> implements PermissionResource {
     ...
     * 关联组织机构，可以为空
     */
    @Column(comment = "机构ID", type = ColumnType.CLOB, order = 4)
    private String partyId;
    @Column(comment = "机构编码", type = ColumnType.CLOB, order = 4)
