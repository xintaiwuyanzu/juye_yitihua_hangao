<template>
    <div class="login" id="particles-js">
        <Particles></Particles>
        <div class="content1">
            <div class="logo"><img src="./title.png" style="width: 62%;margin-bottom: -30px"/></div>
            <div class="loginform" v-if="!sso">
                <div class="logo">
                    <span style="font-size: 30px;padding-top: 10px;padding-bottom: 40px;letter-spacing:4px">用户登录</span>
                </div>
                <div class="form">
                    <el-form>
                        <el-form-item>
...
<script>
    ...
    //import Canvas from './utils/canvas-nest.js'
