<template>
  <section>
    ...
    <!--    <file-list v-on:uploadYuanwen="updateStatusYuanwen" refType="archive" :formDataId="row.id" style="margin-top: 5px" width="50%" v-if="fileListDialog"/>-->
    <file-list v-on:uploadYuanwen="updateStatusYuanwen" refType="archive" :print="false" :deleter="false"
               :formDataId="row.id" :upload="false"
               style="margin-top: 0px;height: 0;width: 0"
