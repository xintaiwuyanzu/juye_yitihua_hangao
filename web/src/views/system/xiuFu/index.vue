  ...
  <section>
    ...
    <div class="index_main" v-loading="loading">
      <el-table :data="data" border height="80vh" class="table-container" align="center">
        ...
        <el-table-column prop="kuFangMingCheng" label="库房名称" align="center" header-align="center"
                         show-overflow-tooltip/>
        <el-table-column prop="createDate" label="送修日期" align="center" header-align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            {{ timestampToTime(scope.row.createDate) }}
          </template>
        </el-table-column>
        <el-table-column prop="fileName" label="名称" align="center" header-align="center" show-overflow-tooltip/>
        <el-table-column prop="fileNum" label="编号" align="center" header-align="center" show-overflow-tooltip/>
        <el-table-column prop="personName" label="记录员" align="center" header-align="center" show-overflow-tooltip/>
        <el-table-column prop="maintenanceReasons" label="维修原因" align="center" header-align="center"
                         show-overflow-tooltip/>
        <el-table-column prop="maintenanceRecord" label="维修记录" align="center" header-align="center"
                         show-overflow-tooltip/>
        <el-table-column prop="sendPeople" label="送修人" align="center" header-align="center" show-overflow-tooltip/>
        <el-table-column prop="maintenancePeople" label="维修人" align="center" header-align="center"
                         show-overflow-tooltip/>
