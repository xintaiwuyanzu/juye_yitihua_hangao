<template>
  <section>
    <el-form :model="searchForm" ref="searchForm" inline class="searchForm">
      ...
      <el-form-item label="送修时间" style="margin-left: 8px">
        <el-date-picker
            v-model="valueTime"
            type="daterange"
            align="right"
    ...
    <el-dialog :visible.sync="edit" :title="(form.id?'编辑':'添加')" width="50%" :close-on-click-modal="false"
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="150px">
        ...
        <el-form-item label="名称" prop="fileName" required style="margin-top: 7px">
          <el-input v-model="form.fileName" placeholder="请输入名称" clearable/>
        </el-form-item>
        <el-form-item label="编号" prop="fileNum" required style="margin-top: 7px">
          <el-input v-model="form.fileNum" placeholder="请输入编号" clearable/>
        </el-form-item>
        ...
        <el-form-item label="维修原因" prop="maintenanceReasons" style="margin-top: 7px">
          <el-input v-model="form.maintenanceReasons" type="textarea" placeholder="请输入维修原因" clearable/>
        </el-form-item>
        <el-form-item label="维修记录" prop="maintenanceRecord" style="margin-top: 7px">
          <el-input v-model="form.maintenanceRecord" type="textarea" placeholder="请输入维修记录" clearable/>
        </el-form-item>
        <el-form-item label="送修人" prop="sendPeople" style="margin-top: 7px">
          <el-input v-model="form.sendPeople" type="textarea" placeholder="请输入送修人" clearable/>
        </el-form-item>
        <el-form-item label="维修人" prop="maintenancePeople" style="margin-top: 7px">
          <el-input v-model="form.maintenancePeople" type="textarea" placeholder="请输入维修人" clearable/>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exp() {
      ...
      let url = 'api/xiuFu/exp?startDate=' + this.searchForm.startDate +
