    ...
    <div class="index_main" v-loading="loading">
      <el-table :data="data" border height="80vh" class="table-container" align="center">
        ...
        <el-table-column prop="kuFangMingCheng" label="库房名称" align="center" header-align="center" show-overflow-tooltip/>
          ...
          <el-table-column prop="wenDu" label="温度" align="center" header-align="center" show-overflow-tooltip/>
          <el-table-column prop="shiDu" label="相对湿度" align="center" header-align="center" show-overflow-tooltip/>
          <el-table-column prop="personName" label="记录人" align="center" header-align="center" show-overflow-tooltip/>
          <!--        <el-table-column prop="sheBeiMingCheng" label="设备名称" header-align="center" show-overflow-tooltip width="220px"/>-->
