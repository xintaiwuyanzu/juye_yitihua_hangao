  ...
  <section>
    ...
    <el-dialog :visible.sync="edit" :title="(form.id?'编辑':'添加')" width="50%" :close-on-click-modal="false"
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="150px">
        ...
        <el-form-item label="除尘情况" prop="chuChen" required style="margin-top: 7px">
          <el-input v-model="form.chuChen" placeholder="请输入除尘情况" clearable/>
        </el-form-item>
        <el-form-item label="清理人" prop="cleaner" required style="margin-top: 7px">
          <el-input v-model="form.cleaner" placeholder="请输入清理人姓名" clearable/>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exp() {
      ...
      let url = 'api/chuChen/exp?startDate=' + this.searchForm.startDate +
