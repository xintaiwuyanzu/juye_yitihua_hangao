    ...
    <div class="index_main" v-loading="loading">
      <el-table :data="data" border height="80vh" class="table-container" align="center">
        ...
        <el-table-column prop="kuFangMingCheng" label="库房名称" align="center" header-align="center" show-overflow-tooltip/>
          ...
          <el-table-column prop="num" label="数量" align="center" header-align="center" show-overflow-tooltip/>
          ...
          <el-table-column prop="jiaoJuan" label="交卷人" align="center" header-align="center" show-overflow-tooltip/>
          <el-table-column prop="shouJuan" label="收卷人" align="center" header-align="center" show-overflow-tooltip/>
