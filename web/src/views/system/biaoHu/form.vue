  ...
  <section>
    ...
    <el-dialog :visible.sync="edit" :title="(form.id?'编辑':'添加')" width="50%" :close-on-click-modal="false"
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="150px">
        ...
        <el-form-item label="数量" prop="num" required style="margin-top: 7px">
          <el-input v-model="form.num" placeholder="请输入数量" clearable/>
        </el-form-item>
        ...
        <el-form-item label="记录人" prop="userName" required style="margin-top: 7px">
          <el-input v-model="form.userName" placeholder="请输入记录人" clearable/>
        </el-form-item>
        <el-form-item label="交卷人" prop="jiaoJuan" required style="margin-top: 7px">
          <el-input v-model="form.jiaoJuan" placeholder="请输入交卷人" clearable/>
        </el-form-item>
        <el-form-item label="收卷人" prop="shouJuan" required style="margin-top: 7px">
          <el-input v-model="form.shouJuan" placeholder="请输入收卷人" clearable/>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exp() {
      ...
      let url = 'api/biaoHu/exp?startDate=' + this.searchForm.startDate +
