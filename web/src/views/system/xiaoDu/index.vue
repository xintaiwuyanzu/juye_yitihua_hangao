    ...
    <div class="index_main" v-loading="loading">
      <el-table :data="data" border height="80vh" class="table-container" align="center">
        ...
        <el-table-column prop="kuFangMingCheng" label="库房名称" align="center" header-align="center" show-overflow-tooltip/>
          ...
          <el-table-column prop="fanWei" label="消毒范围" align="center" header-align="center" show-overflow-tooltip/>
          <el-table-column prop="way" label="消毒方式" align="center" header-align="center" show-overflow-tooltip/>
          <el-table-column prop="disinfector" label="消毒员" align="center" header-align="center" show-overflow-tooltip/>
