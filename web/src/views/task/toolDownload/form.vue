<template>
  <section>
    ...
    <el-dialog title="工具上传" :visible.sync="imports" :modal-append-to-body='false' append-to-body>
      <el-upload style="text-align: center;margin-top: 50px"
                 ...
                 :auto-upload="false"
                 :file-list="fileList">
        <el-button slot="trigger" size="medium" type="primary" icon="el-icon-search">选取工具</el-button>
        <el-button style="margin-left: 10px;" size="medium" type="success" @click="submitUpload">
          <i class="el-icon-upload el-icon--right"/>上传工具
        </el-button>
