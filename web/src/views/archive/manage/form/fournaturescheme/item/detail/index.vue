<template>
    <section>
        ...
        <div class="index_main">
            <el-table class="table-container" :data="data" border height="100%" ref="table">
        ...
        <el-dialog :title="edit?'编辑元数据项':'添加元数据项'"
            ...
            <el-form ref="form" :model="form" inline label-width="100px" :rules="rules">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="元数据类型" filterable clearable prop="formFieldType">
            ...
            return {
                rules: {
                    ...
                    ifRequired: [
                        ...
                        {required: true, message: '是否必填项不能为空', trigger: 'change'}
                    ],
                    formFieldType: [
                ...
                data: [],
                fields: [
                    {label: '题名', fieldCode: 'TITLE'},
                    {label: '档号', fieldCode: 'ARCHIVE_CODE'},
                    {label: '年度', fieldCode: 'VINTAGES'},
                    {label: '保管期限', fieldCode: 'SAVE_TERM'},
                    {label: '形成日期', fieldCode: 'FILETIME'},
                ],
                form: {
                    metaDict: ''
                },
