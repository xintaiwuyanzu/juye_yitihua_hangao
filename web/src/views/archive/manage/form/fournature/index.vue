                    ...
                    <el-col :span="12">
                        <el-form-item label="元数据名称" prop="formFieldCode">
                            <el-select v-model="form.formFieldCode" filterable clearable placeholder="请选择">
                                <el-option style="width: 210px" v-for="item in fields" :key="item.fieldCode"
...
<script>
  ...
  export default {
        ...
        methods: {
            ...
            loadFields() {
                this.loading = true
                this.$post('manage/form/findFieldList', {formDefinitionId: this.$route.query.formId}).then(({data}) => {
            ...
            loadData() {
                ...
                this.$post('fournatureschemeitemmethod/page', {
                    page: false,
                    formDefineId: this.$route.query.formId
                }).then(({data}) => {
                    if (data && data.success) {
                        this.data = data.data
                    }
